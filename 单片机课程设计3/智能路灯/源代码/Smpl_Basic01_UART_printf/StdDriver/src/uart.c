 ...
 *                                      - UART_INTSTS_DATWKIF_Msk   : Data Wake-up interrupt
 *                                      - UART_INTSTS_CTSWKIF_Msk   : CTS Wake-up interrupt
 ...
 *    @param[in]    uart                The pointer of the specified UART module.
 *    @param[in]    u32InterruptFlag    The specified interrupt of UART module.
 *                                      - UART_INTEN_WKCTSIEN_Msk   : CTS wake-up interrupt
 *                                      - UART_INTEN_WKDATIEN_Msk   : Data wake-up interrupt
