 ...
 *                              - UART_INTEN_WKCTSIEN_Msk   : CTS wakeup interrupt
 *                              - UART_INTEN_WKDATIEN_Msk   : Data wakeup interrupt
 ...
 *                                  - UART_INTSTS_RXTOINT_Msk   : Rx time-out interrupt
 *                                  - UART_INTSTS_MODEMINT_Msk  : Modem status interrupt
 *                                  - UART_INTSTS_RLSINT_Msk    : Receive Line Status interrupt
 *                                  - UART_INTSTS_THREINT_Msk   : Tx empty interrupt
 *                                  - UART_INTSTS_RDAINT_Msk    : Rx ready interrupt
 *
