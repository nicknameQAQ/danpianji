...
/**
  ...
  *         For 10 bit mode, its two LSB bits are set to 0 by hardware default.
  */
...
/**
  * @brief Enable 10-bit mode.
  * @param[in] dac Base address of DAC module.
  * @return None
  * @details 10 bit left alignment: user has to load data into DAC_DAT[15:6] bits.
  *         10 bit right alignment: user has to load data into DAC_DAT[11:2] bits.
  */
#define DAC_ENABLE_10BIT_MODE(dac) ((dac)->CTL |= DAC_CTL_TENBITEN_Msk)

/**
  * @brief Enable 12-bit mode.
  * @param[in] dac Base address of DAC module.
  * @return None
  ...
  */
#define DAC_ENABLE_12BIT_MODE(dac) ((dac)->CTL &= ~DAC_CTL_TENBITEN_Msk)
...
/**
  ...
  * @details 12 bit left alignment: user has to load data into DAC_DAT[15:4] bits.
  *         12 bit right alignment: user has to load data into DAC_DAT[11:0] bits.
  *         10 bit left alignment: user has to load data into DAC_DAT[15:6] bits.
  *         10 bit right alignment: user has to load data into DAC_DAT[11:2] bits.
  */
