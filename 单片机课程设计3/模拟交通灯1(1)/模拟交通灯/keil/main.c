...
uchar data sec_dx=60;  			//东西数默认
uchar data sec_nb=60;			//南北默认值
uchar data set_timedx=60;		//设置东西方向的时间
...
{	  
	...
	if(sec_dx==3&&sec_nb==3) 		//当东西倒计时到0时，重置5秒，用于黄灯闪烁时间
	{
//		sec_dx=3;
		shanruo=1;
	}
	if(sec_nb==3&&sec_dx==3)		//当南北倒计时到0时，重置5秒，用于黄灯闪烁时间
	{
//		sec_nb=5;
		shanruo=1;
	}
