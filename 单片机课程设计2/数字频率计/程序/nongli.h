...
//
///*其中Tim[0]Bit7?表示世纪,1为20?世纪19xx,0?为21?世纪20xx*/
//
...
////月修正数据表
//
//uchar week_code[12]={0,3,3,6,1,4,6,2,5,0,3,5};
//
//uint temp4,code_addr;
//
...
//}
//
//bit get_moon_day(uchar month_p,Wordcode_addr)
//
...
//		//小还是小月,大月返回1,小月返回0
//		
//		if(flag2==0){temp1=29;}else{temp1=30;}//小月29天、大月30?天
//		
