...
/*******************外部数据存储空间**********************/
   ...
   ADCDATA     : origin = 0x110000, length = 0x010000
   DACDATA1	   : origin = 0x120000, length = 0x010000	
   DACDATA2	   : origin = 0x130000, length = 0x010000
   DACDATA3	   : origin = 0x140000, length = 0x010000
   DACDATA4	   : origin = 0x150000, length = 0x010000
   DACDATA5	   : origin = 0x160000, length = 0x010000
   DACDATA6	   : origin = 0x170000, length = 0x010000
}
...
/*******************外部数据存储变量**********************/
   ...
   AdcDataFile       : > ADCDATA,     PAGE = 1
   DacDataFile1      : > DACDATA1,    PAGE = 1
   DacDataFile2      : > DACDATA2,    PAGE = 1
   DacDataFile3      : > DACDATA3,    PAGE = 1
   DacDataFile4      : > DACDATA4,    PAGE = 1
   DacDataFile5      : > DACDATA5,    PAGE = 1
   DacDataFile6      : > DACDATA6,    PAGE = 1
